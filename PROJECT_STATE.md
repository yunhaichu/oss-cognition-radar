...
Use `signal_breakdown` to strengthen archive pattern ranking/filtering so repeated claim-gap repair moves can be sorted by automatic evidence structure, not just repetition count.
