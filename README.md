...
- 把 profile-to-claim/evidence explanation paths 接入 dashboard 仓库详情页，让浏览器端也能从画像继续展开到 claim gap 和证据链
