...
- `--archive-dashboard [PATH]`：生成一个可直接打开的静态 HTML dashboard，包含搜索、track 过滤、confidence source 过滤、最低分过滤、跨项目 patterns、项目详情、claims、claim gaps、evidence acquisition bindings、route detail selectors、preset validation fixtures、单个 fixture bundle 下载、fixture validation preview 和 evidence 摘要
